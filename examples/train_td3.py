...
That is the point of a Gymnasium environment: the problem stays fixed, and any
algorithm can be dropped in to learn a policy for it.
...
if __name__ == "__main__":
    # TD3's policy is deterministic, so it needs explicit exploration noise
